...
const OtherMarketCard: React.FC<SimpleMarketProps> = ({
  type,
  data,
  homeTeamName,
  awayTeamName,
  ...
  return (
    <Card className="h-full bg-gray-950/50 overflow-hidden">
      <CardHeader className="bg-gray-900/20">
        <CardTitle className="text-white text-base flex items-center gap-2 border-l-2 border-primary-green pl-2">
          {type}
        </CardTitle>
      </CardHeader>
      <CardContent>
            ...
            >
              <div className="flex flex-col items-center w-full z-10 space-y-2">
                <span className="text-xs font-semibold uppercase tracking-wider text-center text-primary-green">
                  {OtherMarketLabel(label, homeTeamName, awayTeamName)}
                </span>
