...
const Banner: React.FC = () => {
  return (
    <section className="relative flex min-h-120 w-full flex-col items-center justify-center overflow-hidden bg-primary-bg px-4 mb-10 md:mb-0 sm:pt-20 sm:pb-40 text-center">
