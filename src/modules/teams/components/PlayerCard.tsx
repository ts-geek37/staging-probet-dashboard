...
const PlayerCard: React.FC<Props> = ({ player, className }) => {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center w-7 h-7 rounded-full bg-primary-green text-[11px] font-bold text-white shrink-0">
        {player.jersey_number || "-"}
      </div>

      <div className="relative w-8 h-8 overflow-hidden bg-primary-gray/10 border border-white/10 shrink-0">
        <Image
      ...
      <Badge
        ...
        className="hidden sm:inline-flex
             ...
             border-none px-2 h-5 text-[9px] uppercase font-bold
