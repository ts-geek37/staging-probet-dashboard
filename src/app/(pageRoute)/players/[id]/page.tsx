...
export const generateMetadata = async ({
  ...
  if (!player) {
    return seo({
      title: "Player",
      description:
        "Explore player details, fixtures, standings, and football predictions on ProBetPredictions.",
    });
  }
  ...
  return seo({
    ...
    description: player
      ? `${player.name}, a professional footballer for ${player.teams?.[0].name}, born on ${player.date_of_birth}. View age, position, nationality, market value, contract details, and latest performance stats on ProBetPredictions.`
